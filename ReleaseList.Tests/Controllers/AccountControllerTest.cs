...
using ReleaselList.web;
using ReleaselList.web.Controllers;
using ReleaselList.web.Models;

namespace ReleaselList.Tests.Controllers
{
    ...
    public class AccountControllerTest
    {
        ...
        public void LogOn_Post_ReturnsRedirectOnSuccess_WithoutReturnUrl()
        {
            ...
            // Act
            ActionResult result = controller.LogOn(model, false, null);
        ...
        public void LogOn_Post_ReturnsRedirectOnSuccess_WithReturnUrl()
        {
            ...
            // Act
            ActionResult result = controller.LogOn(model, false, "/someUrl");
